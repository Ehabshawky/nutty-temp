...
import { Mail, Phone, MapPin, Shield, Lock, Eye, AlertCircle } from 'lucide-react';
...
export default function PrivacyPolicyPage() {
  ...
  const sections = t('privacyPolicy.sections', { returnObjects: true }) as Record<string, { title: string; content: string }>;
    ...
    <div className={`min-h-screen bg-slate-50 dark:bg-gray-900 pt-32 pb-20 ${isRTL ? 'text-right' : 'text-left'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Shield className="absolute -right-8 -top-8 w-64 h-64 text-slate-50 dark:text-gray-700/50 -z-0 rotate-12" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
              ...
              <p>
                {t('privacyPolicy.lastUpdated')}: {new Date('2025-01-04').toLocaleDateString(i18n.language === 'ar' ? 'ar-EG' : 'en-US', {
                  year: 'numeric',
                  month: 'long',
                  day: 'numeric'
                })}
        ...
        {/* Bottom Contact Card (Optionally repeated from section 10 for consistency) */}
        <motion.div
        ...
        >
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">
            {isRTL ? 'هل لديك أي أسئلة؟' : 'Have any questions?'}
          </h3>
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            {isRTL ? 'نحن هنا لمساعدتكم في أي استفسارات تتعلق بخصوصيتكم.' : 'We are here to help with any inquiries regarding your privacy.'}
          </p>
          <a 
            href="/contact"

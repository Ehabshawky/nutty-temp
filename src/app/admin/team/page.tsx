        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-8 border border-gray-100 dark:border-gray-700">
            ...
            <div className="flex items-center gap-4 mt-8 pt-6 border-t border-gray-100 dark:border-gray-700">
              ...
              {editId && (
                <button onClick={handleCancel} className="px-8 py-3 bg-gray-200 dark:bg-gray-700 rounded-lg font-bold">
                  {isRTL ? "إلغاء" : "Cancel"}
                </button>
              )}
            </div>
          ...
          <div className="space-y-4">
            ...
            {members.length === 0 ? (
              ...
              <div className="grid grid-cols-1 gap-4">
                {members.map((m) => (
                  <div key={m.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 flex items-center gap-4 border border-gray-50 dark:border-gray-700 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <h4 className="font-bold text-gray-900 dark:text-white truncate">{m.name}</h4>
                        {m.featured && <Star className="w-4 h-4 fill-yellow-400 text-yellow-400" />}
                      </div>
                      <p className="text-xs font-bold text-nutty-blue uppercase tracking-wider">{m.position_en}</p>
                      <p className="text-xs text-gray-400 dark:text-gray-500 uppercase">{m.department}</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <button
